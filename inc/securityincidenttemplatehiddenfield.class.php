 ...
 */
class PluginSecurityincidentsSecurityIncidentTemplateHiddenField extends ITILTemplateHiddenField
{
   public static function getTable($classname = null) {
       return 'glpi_plugin_securityincidents_templates_hiddenfields';
   }
