 ...
 */
class PluginSecurityincidentsSecurityIncidentTemplateReadonlyField extends ITILTemplateReadonlyField
{
   public static function getTable($classname = null) {
       return 'glpi_plugin_securityincidents_templates_readonlyfields';
   }
